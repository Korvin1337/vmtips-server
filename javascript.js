...
const App = () => {
    ...
    const toggleDayLock = (date) => {
        requireAdmin(() => {
            setModalConfig({
                ...
                type: "confirm",
                onConfirm: () => {
                    setState(s => ({ ...s, lockedDays: { ...s.lockedDays, [date]: !s.lockedDays?.[date] } }));
                    setModalConfig(null);
                }
            });
        });
    ...
    if (!hasAttemptedLogin) return (
        <div className="flex flex-col items-center justify-center min-h-screen p-4 pb-16 bg-slate-900 relative gap-8">
                                        ...
                                        return (
                                            <div key={f.id} className="bg-slate-800 border border-slate-700 rounded-lg p-3 flex flex-row items-center gap-4">
                                                ...
                                                <div className="flex-1 flex items-center justify-between gap-4 min-w-0">
                                                    <div className="text-right flex-1 min-w-0 font-medium text-slate-200 truncate" title={f.home}>{f.home}</div>
                                                    {has
                                                        ? <div className="flex items-center gap-2 bg-slate-950 px-3 py-1.5 rounded border border-slate-700 shrink-0">
                                                        ...
                                                        : <div className="flex items-center justify-center bg-slate-900 px-3 py-1.5 rounded border border-slate-700/50 w-24 shrink-0">
                                                            <span className="text-slate-600 font-bold">–</span>
                                                          </div>}
                                                    <div className="text-left flex-1 min-w-0 font-medium text-slate-200 truncate" title={f.away}>{f.away}</div>
                                                </div>
